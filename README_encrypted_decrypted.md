...
Step 3:       mafmm
Step 4:       puwcr
Step 5:       upcwr  ← Final encrypted result
```
...
$ ./cipher -e input.txt
Encrypting...
Encryption complete in 0 ms.
Outfile created: input_encrypted.txt

$ ./cipher -d input_encrypted.txt
Decrypting...
Decryption complete in 0 ms.
Outfile created: input_encrypted_decrypted.txt
```
